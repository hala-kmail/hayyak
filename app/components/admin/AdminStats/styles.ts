...
export const adminStatsStyles = {
  ...
  top3ProgressSection: 'mt-2 pt-2 border-t border-gray-200',
  ...
  top3ProgressBar: 'mt-1.5 h-1.5 bg-gray-bg rounded-full overflow-hidden',
  ...
  leadingIconWrapper: 'bg-gold/10 p-1.5 rounded-lg',
  ...
  visitorVotersSection: 'mx-4 mb-4 p-4 rounded-lg bg-gradient-to-br from-grey-blue/10 to-navy-blue/10 border border-grey-100',
  ...
  visitorVoterCard: (isVoter: boolean) =>
    `p-3 rounded-lg ${isVoter ? 'bg-lime-green/10 border border-lime-green/30' : 'bg-gold/10 border border-gold/30'}`,
  visitorVoterLabel: 'text-xs font-medium text-warm-grey mb-0.5',
  visitorVoterValue: (isVoter: boolean) =>
    `text-lg font-bold ${isVoter ? 'text-navy-blue' : 'text-navy-blue'}`,
  visitorVoterPercent: (isVoter: boolean) =>
    `text-xs font-medium ${isVoter ? 'text-lime-green' : 'text-gold'}`,
  visitorProgressBar: 'h-2 rounded-full overflow-hidden flex',
  visitorProgressVoters: 'bg-lime-green',
  visitorProgressNonVoters: 'bg-gold',
  visitorByDayTable: 'w-full text-xs',
  visitorByDayRow: 'border-b border-gray-200 last:border-0',
