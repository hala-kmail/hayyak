...
export const layoutStyles = {
  ...
  sidebarCloseBtn: 'lg:hidden p-1.5 rounded-lg hover:bg-gray-bg transition-colors',
  ...
  sidebarLink: (isActive: boolean) =>
    `flex items-center gap-2 px-3 py-2 rounded-lg transition-all duration-200 text-sm ${
      isActive ? 'bg-gold text-white shadow-sm' : 'text-navy-blue hover:bg-gray-bg'
    }`,
  sidebarLinkText: 'font-medium',
  sidebarFooter: 'p-3 border-t border-gray-200',
  sidebarLogout:
    'w-full flex items-center gap-2 px-3 py-2 rounded-lg text-navy-blue hover:bg-navy-blue/10 transition-all duration-200 text-sm',
