...
export const modalStyles = {
  ...
  header: 'sticky top-0 bg-white border-b border-gray-200 px-4 py-3 flex items-center justify-between rounded-t-xl z-10',
  title: 'text-base font-bold text-navy-blue',
  closeBtn:
    'w-8 h-8 rounded-lg bg-gray-bg hover:bg-navy-blue/10 flex items-center justify-center text-warm-grey hover:text-navy-blue transition-colors',
  closeBtnDisabled:
    'w-8 h-8 rounded-lg bg-gray-bg hover:bg-navy-blue/10 flex items-center justify-center text-warm-grey hover:text-navy-blue transition-colors disabled:opacity-50 disabled:cursor-not-allowed',
  content: 'px-4 py-4',
  form: 'space-y-4',
  ...
  formError: 'bg-navy-blue/10 border border-gray-200 rounded-lg p-3',
  formErrorText: 'text-xs font-bold text-navy-blue',
  submitBtn:
  ...
  warningIcon: 'w-12 h-12 rounded-full bg-navy-blue/10 flex items-center justify-center',
  warningIconSvg: 'w-6 h-6 text-navy-blue',
  ...
  cancelBtn:
    'flex-1 py-2.5 text-sm bg-gray-bg text-navy-blue rounded-lg font-semibold hover:bg-navy-blue/10 transition-all disabled:opacity-50 disabled:cursor-not-allowed',
  confirmBtn:
    'flex-1 py-2.5 text-sm bg-navy-blue text-white rounded-lg font-semibold hover:bg-navy-blue/90 hover:shadow-md transition-all disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center gap-1.5',
} as const;
