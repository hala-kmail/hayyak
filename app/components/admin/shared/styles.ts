...
export const sharedStyles = {
  ...
  searchInput:
    'w-full pr-10 pl-3 py-2 text-sm border border-gray-200 rounded-lg focus:border-gold focus:outline-none transition-colors text-navy-blue bg-white',

  loadingContainer: 'bg-white rounded-xl shadow-md p-8 text-center',
  loadingSpinner:
    'inline-block w-6 h-6 border-2 border-gold border-t-transparent rounded-full animate-spin mb-3',
