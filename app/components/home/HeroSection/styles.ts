...
export const heroStyles = {
  ...
  badge: 'font-subhead text-sm md:text-base inline-flex items-center gap-2 bg-navy-blue backdrop-blur-lg px-5 py-2 rounded-2xl font-medium mb-8 border border-white/20 shadow-xl shadow-black/5 animate-fade-in-up text-white',
  ...
  ctaButton: 'font-cta text-cta px-8 py-3 bg-white text-navy-blue rounded-xl font-normal hover:bg-navy-blue hover:text-white transition-all duration-300 shadow-lg shadow-black/10 hover:shadow-xl hover:shadow-gold/20 flex items-center gap-3 group active:scale-[0.97] border border-white/20 hover:border-gold/30',
