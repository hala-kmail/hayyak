...
export const heroStyles = {
  ...
  container: 'relative h-[680px] md:h-[680px] w-full bg-gradient-to-br from-navy-blue via-navy-blue to-turquoise flex items-center overflow-hidden',
  ...
  badge: 'inline-flex items-center gap-2 bg-gold backdrop-blur-lg px-5 py-2 rounded-2xl text-xs font-black mb-8 border border-white/20 shadow-xl shadow-black/5 animate-fade-in-up text-navy-blue',
  ...
  visualIcon: 'w-24 h-24 bg-gradient-to-tr from-turquoise to-gold rounded-full flex items-center justify-center text-white text-5xl shadow-lg mb-4',
  visualStars: 'flex gap-1 text-gold mb-2',
  visualText: 'text-navy-blue font-black text-lg',
  visualHeart: 'absolute top-0 -right-4 w-16 h-16 bg-white rounded-2xl shadow-xl flex items-center justify-center text-gold text-2xl animate-float [animation-delay:1s] border border-gray-50',
  visualSparkle: 'absolute -bottom-4 -left-2 w-20 h-20 bg-gold text-white rounded-3xl shadow-xl flex items-center justify-center text-3xl animate-float [animation-delay:2s]',
