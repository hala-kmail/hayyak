...
export function NeighborhoodsGrid({
  ...
  const displayNeighborhoods = activeTab === 'top' ? topNeighborhoods : sortedNeighborhoods;
        ...
        >
          <div
            className={`flex gap-4 ${
              activeTab === 'all' ? 'flex-nowrap' : 'flex-wrap justify-center'
            }`}
          >
            {displayNeighborhoods.map((n, index) => {
              ...
              return (
                <button
                  ...
                  } ${activeTab === 'all' ? 'w-[380px]' : 'w-full sm:w-[calc(50%-0.5rem)] lg:w-[calc(33.333%-0.67rem)]'}`}
                >
                  {/* Compact Header */}
